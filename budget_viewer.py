from helpers import display_validator_prompt, display_choices_prompt, print_error, print_msg, valid_year, valid_money, session, console
        ...
        while True:
            ...
            if not budgets:
                ...
                for total in category_totals.keys():
                    ...
                    if amount > 0:
                        console.print(f'${amount:.2f}',style="green", highlight=False)

                    else:
                        console.print(f'${amount:.2f}', style="red", highlight=False)

                console.print(f'Extra income: ${budget.extra_income}')
